        ...
        <div className="pt-18">
            ...
            <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
               ...
               <div className="relative text-center text-(--background)">
                ...
                <h1 className="heading-hero mb-6">Aloha, Tiff Amber</h1>
                <p className="text-body max-w-md mx-auto mb-8 opacity-90 text-base">Island-inspired jewelry made with love. Delicate, golden, and uniquely yours.</p>
                <Link className="btn-primary inline-block" to="/products/:category">Shop Collection</Link>
               </div>
            </section>
